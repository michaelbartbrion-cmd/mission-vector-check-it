...
(function(){
'use strict';
if(window.top!==window.self||window.MVCI_WORK_EMAIL_READER_013)return;
const VERSION='work-email-reader-0.1.3-discovery';
const DEFAULT_ENDPOINT='https://base44.app/api/apps/6aa6b7634a031657377d4fad/functions/telemetryBridge';
const ROOT_ID='mvci-work-email-reader-v013';
...
const initialBadge=(badge,next)=>{const b=clean(badge).toUpperCase(),n=clean(next);return /^[A-Z0-9]{1,3}$/.test(b)&&n.length>b.length&&initialsOf(n)===b};
